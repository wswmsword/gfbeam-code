(function() {
   var horizontalElem = document.getElementById('project-list'),
      ...
      uriList = '/proxy/hulaa/subscribe/sweetcore',
      ...
      for (i = 0; i < length; ++ i){
         ...
         list_html += '<div class="project-holder">'
                        ...
                        + '<div class="scrollY">'
                           ...
                           + '<a class="button detail-button" href="' + '/project/bloom/' + list[i].id + '">详细</a>'
   ...
   function initData() {
      util.restserve('get', uriList, functionGrapes.servecallback.listFruxes, [
         ['', pager.incr()]
      ]);
